...
### 1.2. Ссылки
План проекта создан на основании [Устава проекта](./project_charter.md) и
является главным документом, поэтому различные его разделы будут детально раскрываться в других документах:
